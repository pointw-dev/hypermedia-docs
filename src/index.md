...
features:
  ...
  - title: Timeless API design
    icon: 📆
    details: Craft your API for the long haul. Distributed services that last decades will change over time.  With hypermedia you can make these changes safely, without breaking your clients.
    linkText: Learn more
    link: /introduction/what-is
